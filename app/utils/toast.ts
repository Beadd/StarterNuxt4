...
export function showtoastratelimit(
  toast: ToastServiceMethods,
  t: (key: string) => string,
) {
  showtoast(toast, t("Rate limit reached"), "error");
}

export function showtoastcheckform(
  toast: ToastServiceMethods,
  t: (key: string) => string,
) {
  showtoast(toast, t("Please check the form"), "error");
}
